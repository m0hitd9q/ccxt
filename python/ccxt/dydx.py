...
class dydx(Exchange):
    ...
    def fetch_markets(self, params={}):
        ...
        for i in range(0, len(keys)):
            ...
            stepSize = self.safe_number(market, 'stepS  ize')
    ...
    def fetch_trading_fees(self, params={}):
        self.load_markets()
        response = self.publicGetConfig(params)
        # {
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        response = self.publicGetCandlesMarket(self.extend(request, params))
        #
        # {
        #   "candles": [
        #     {
    ...
    def fetch_tickers(self, symbols=None, params={}):
        ...
        response = self.publicGetStatsMarket(self.extend(request, params))
        # {
        #     markets: {
        #       'ETH-USD': {
        #         market: 'ETH-USD',
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        hashHex = self.stark_hash_hex(orderToSign, 'order')
        signature = self.stark_signature(hashHex)
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        if symbol is not None:
            ...
            response = self.privateDeleteActiveOrders(self.extend(request, params))
            # {
            #     "cancelOrders": [
            #         {
    ...
    def fetch_order(self, id, symbol=None, params={}):
        ...
        if clientOrderId is not None:
            ...
            response = self.privateGetOrdersClientId(self.extend(request, params))
        else:
            request = {'id': id}
    ...
    def register_api_key(self, params=None):
        response = self.privatePostApiKeys(params)
        return response

    def make_onboard(self, params=None):
    ...
    def stark_signature(self, hashHex):
    ...
    def stark_hash_hex(self, signObject, type):
        assetIdCollateralHex = self.urls['api']['data']['assetIdCollateralHex']
        positionId = self.get_position_id()
